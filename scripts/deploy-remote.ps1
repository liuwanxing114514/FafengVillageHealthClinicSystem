...
# 前提：SSH 配置 Host nas；已 push release/vX.Y.Z-prod 且 Release Images CI 已绿勾
...
Write-Host ">> 提示：请确认已 push release/vX.Y.Z-prod 分支、GitHub Actions「Release Images」已成功，且今日 DSM 备份已完成"
Write-Host ""
