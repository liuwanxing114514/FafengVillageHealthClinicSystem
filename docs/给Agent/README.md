...
| [下一版对话起始.md](下一版对话起始.md) | **v2.4 起**复制即用的开对话 Prompt |
...
**下一版本：v2.4 RAG 运维与 Embedding 管理** → 分支 `v2.4-rag-ops`，详见 [下一版对话起始.md](下一版对话起始.md) 与 [功能点与实现记录.md](功能点与实现记录.md)「当前工作点」。
